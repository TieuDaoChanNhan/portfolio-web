...
List<Project> projectList = [
  Project(
    'Health For All Application',
    'Presenting "HFA" - a Flutter UI application thatintegrates portable health devices to monitor key metrics, sync data in real-time, and connect users to caregivers.',
    'assets/images/HFA.png',
    'https://github.com/trvtinh/hfa',
  ),
  // Project(
