  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(percentage: 1, title: 'C++',image: 'assets/icons/c.png'),
        AnimatedLinearProgressIndicator(percentage: 0.8, title: 'Data Structure and Algorithm',image: 'assets/icons/dsa.png'),
      ],);
  }
}
